defmodule TwirpTest do
  ...
  test "clients can call services" do
    ...
    req = struct(Req, msg: "Hello there")
  ...
  test "clients allow interceptors" do
    ...
    assert {:ok, req} = Client.echo(%{deadline: 1000}, struct(Req, msg: "Test"))
    assert req.msg == "Test"
  ...
  test "errors halt the call chain" do
    ...
    assert {:error, %Twirp.Error{}} = Client.echo(%{deadline: 1000}, struct(Req, msg: "Test"))
